...
const directories = {
  [toCamelCaseName(
    process.env.MYSQL_E_ARCHIVE_NAME
  )]: `../src/models/${toCamelCaseName(process.env.MYSQL_E_ARCHIVE_NAME)}`,
...
const poolConfigurations = {
  [toCamelCaseName(process.env.MYSQL_E_ARCHIVE_NAME)]: {
    min: Number(process.env.MYSQL_E_ARCHIVE_POOL_MIN),
    max: Number(process.env.MYSQL_E_ARCHIVE_POOL_MAX),
    idle: Number(process.env.MYSQL_E_ARCHIVE_POOL_IDLE),
    acquire: Number(process.env.MYSQL_E_ARCHIVE_POOL_ACQUIRE),
    evict: Number(process.env.MYSQL_E_ARCHIVE_POOL_EVICT),
...
const sequelizeConfigurations = {
  [toCamelCaseName(process.env.MYSQL_E_ARCHIVE_NAME)]: {
    ...
    database: process.env.MYSQL_E_ARCHIVE_NAME,
    username: process.env.MYSQL_E_ARCHIVE_USER,
    password: process.env.MYSQL_E_ARCHIVE_PASS,
    pool: poolConfigurations[toCamelCaseName(process.env.MYSQL_E_ARCHIVE_NAME)],
    port: Number(process.env.MYSQL_E_ARCHIVE_PORT),
    define: {
      timestamps: false,
      timezone: "+07:00",
    },
    logging: Boolean(process.env.MYSQL_E_ARCHIVE_LOGGING),
    timezone: "+07:00",
