...
export class restApiService {
  ...
  downloadFile(file_path: string) {
    return this.http.get(this.apiUrl + "file/uploads" + file_path, {
      responseType: "blob",
    });
  }

  // Get
  getDocumentData(params: any): Observable<any> {
  ...
  // POST
  addDocumentData(document: any): Observable<any> {
    return this.http.post(this.apiUrl + "documents", document);
  }

  // PUT
  editDocumentData(id: any, document: any): Observable<any> {
    return this.http.put(this.apiUrl + `documents/${id}`, document);
  }
  ...
  /**
   * Document Category Rest Api
   */

  // GET
  getDocumentCategories(params: any = {}): Observable<any> {
    return this.http.get(this.apiUrl + "doc-categories", { params });
  }

  getDocumentCategoryById(id: any): Observable<any> {
    return this.http.get(this.apiUrl + `doc-categories/${id}`);
  }

  // POST
  addDocumentCategory(body: any) {
    return this.http.post(this.apiUrl + "doc-categories", body);
  }

  // PUT
  editDocumentCategory(id: number, body: any) {
    return this.http.put(this.apiUrl + `doc-categories/${id}`, body);
  }

  // DELETE
  deleteDocumentCategory(id: number) {
    return this.http.delete(this.apiUrl + `doc-categories/${id}`);
  }
